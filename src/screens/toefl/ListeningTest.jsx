/**
 * ListeningTest.jsx — Audio-based MCQ test screen.
 *
 * Used for:
 *   • TOEFL Listening section  (format = "LISTENING")
 *   • IELTS Listening section  (format = "LISTENING")
 *
 * Audio is simulated via Web Speech API (SpeechSynthesis).
 * Questions are locked until the user plays the audio at least once.
 * Maximum 2 plays per passage (mirrors real TOEFL policy).
 */
...
// ── Extract spoken text from [Audio prompt: …] marker ────────────────────────
          ...
          <>
            ...
            <button onClick={onStop}
              style={{
                ...
                color: BRAND, fontFamily: SERIF, fontSize: 12,
...
const ListeningTest = ({ session }) => {
  ...
  // For standalone questions, clean the [Audio prompt: ...] prefix from question text
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontFamily: SERIF, fontSize: 10, fontWeight: 700,
              ...
              {hasContext
                ? "Listening — " + (currentGroup.groupTitle || "Audio Passage")
          ...
          {/* Note-taking (passage-based groups only) */}
          {hasContext && (
          ...
          <p style={{
            ...
            {questionsLocked ? "Listen to unlock the questions" : "Choose the best answer"}
          </p>
